...
const qnaList = [
  ...
  // 3. 전기
  {
    q: "5. 하루에 TV를 몇 시간 정도 시청하나요?",//8번 인덱스
    a: [
...
const doList = [ 
  { // 인덱스 0번
    ...
    car_yes: [
      {
        do: "내리막길 운전 시 가속페달 밟지 않기 - CO2 저감량 : 48.3kg  / 비용절감 : 33,984원 / 나무심기효과 : 7.3그루",
      },
      {
        do: "신호대기 시 기어를 중립으로 놓기 - CO2 저감량 : 13kg / 비용절감 : 9,062원 / 나무심기효과 : 2그루",
      },
      {
        do: "자동차 에어컨 사용 - CO2저감량 : 22.7 kg / 비용절감 : 16,010원 / 나무심기효과 : 3.4 그루",
      },
      {
        do: "주기적으로 타이어 공기압 체크하기 - CO2 저감량 : 82.4 kg / 비용절감 :	57,848원 /나무심기효과 : 12.5그루",
      },
      {
    ...
    air_no: [
      {
        // 에어컨 X 단열재 O
        heat_yes: [
          { do: "여름에 에어컨을 사용안하고 겨울에 단열재를 사용하는 것은 환경에 정말 좋습니다!" }, // 멘트 나중에 수정하기
        ],
      },
      {
        // 에어컨 X 단열재 X
        heat_no: [
          {
            do: "단열재 사용으로 열손실 방지하기 - CO2 저감량 : 71.4kg / 비용절감 : 26,260원 / 나무심기효과 : 10.8그루",
          },
        ],
      },
    ],
